/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/jobs/wrangler.jsonc cloudflare/jobs/worker-configuration.d.ts` (hash: 340dfc35e9ec8ce78c77b576cdc92058)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "PROVIDER_DELIVERY_ENABLED" | "STRIPE_CHECKOUT_ENABLED" | "STRIPE_MODE">> {}
}
