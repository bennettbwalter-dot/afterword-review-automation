/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/application/wrangler.jsonc cloudflare/application/worker-configuration.d.ts` (hash: a27bba10e88eeb77b5ef172048ccdb98)
// Runtime types generated with workerd@1.20260714.1 2026-07-20 enable_nodejs_http_server_modules,nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "STRIPE_CHECKOUT_ENABLED" | "STRIPE_MODE" | "PROVIDER_DELIVERY_ENABLED">> {}
}
